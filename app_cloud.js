  ...
  try {
    if (window.AndroidBridge) {
      ...
      const fetchJson = async (name) => {
        ...
        const localBu = safeParseLocal("CHURCH_BUDGET");
        state.budget = localBu.length ? localBu : (bu.length ? bu : (window.INITIAL_BUDGET || []));
        console.log("Loaded all master JSONs!");
    }
