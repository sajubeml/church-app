...
full_apk_v11 = os.path.join(base_dir, "St_Gregorios_Church_Accounting_v11.6.apk")
...
fresh_apk_v11 = os.path.join(base_dir, "St_Gregorios_Church_Accounting_Fresh_v11.6.apk")
...
shutil.copy2(full_apk_v11, os.path.join(dist_dir, "St_Gregorios_Church_Accounting_v11.6.apk"))
shutil.copy2(fresh_apk_v11, os.path.join(dist_dir, "St_Gregorios_Church_Accounting_Fresh_v11.6.apk"))

try:
    subprocess.run(["py", "package_distributable.py"], cwd=base_dir, check=True)
except Exception as e:
    print("[WARNING] package_distributable.py skipped:", e)
