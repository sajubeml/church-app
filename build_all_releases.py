...
full_apk_v76 = os.path.join(base_dir, "St_Gregorios_Church_Accounting_v9.0.apk")
...
fresh_apk_v76 = os.path.join(base_dir, "St_Gregorios_Church_Accounting_v9.0_Fresh.apk")
...
shutil.copy2(full_apk_v76, os.path.join(dist_dir, "St_Gregorios_Church_Accounting_v9.0.apk"))
shutil.copy2(fresh_apk_dest, os.path.join(dist_dir, "St_Gregorios_Church_Accounting_Fresh_Start.apk"))
shutil.copy2(fresh_apk_v76, os.path.join(dist_dir, "St_Gregorios_Church_Accounting_v9.0_Fresh.apk"))
